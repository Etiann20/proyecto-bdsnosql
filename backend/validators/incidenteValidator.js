...
export const validarCrearIncidente = [
    ...
    body("estado").isIn(["Pendiente", "En Progreso", "Resuelto", "Cerrado"]).withMessage("El estado no es válido"),
...
export const validarActualizarIncidente = [
    ...
    body("estado").optional().isIn(["Pendiente", "En Progreso", "Resuelto", "Cerrado"]).withMessage("El estado no es válido"),
